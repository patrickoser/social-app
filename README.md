...
Pages needed:
    ...
    Login and signup
        Can be the same as the comparable login and signup pages. Looked clean and can easily tweak the color and style as I want.
    ...
    A page to display the individual posts you click on.
        Posts should have a like, repost, and 
