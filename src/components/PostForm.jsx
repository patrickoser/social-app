        ...
        <div className="py-2 border-b border-t border-gray-200 dark:border-gray-700">
            <form action="POST" onSubmit={createPost} className="flex">
                ...
                <input 
                    ...
                    required
                />
                <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 ml-2">Post</button>
            </form>
        </div>
    )
}
