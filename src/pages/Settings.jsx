...
const Settings = () => {
    ...
    return (
        <main className="flex max-w-7xl mx-auto py-0 px-3">
            <LeftSidebar />
            <section id="main-content-settings" className="flex-initial w-6/12 mt-5 px-5 pt-3 pb-6 text-center bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-t border-b border-gray-200 dark:border-gray-700">
